...
import { type UserSession, getRoleDisplayName } from "@/lib/permissions";
...
export default function DashboardPage() {
  ...
  const handleMineClick = (mineId: string) => {
    toast.info(`Viewing details for ${mockMines.find(m => m.id === mineId)?.name}`);
  };
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  3 high-priority alerts · 2 compliance predictions · 1 anomaly detected
                </p>
              </div>
            </div>
            <Button variant="outline" size="sm" className="gap-2">
